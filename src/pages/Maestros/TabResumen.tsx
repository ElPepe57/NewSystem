  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <DSKPIBar columns={4}>
          <DSStatCard label="Total Entidades" value={clientes.length + marcas.length + proveedores.length + competidores.length + canales.length} icon={Boxes} variant="info" size="sm" />
          ...
          <DSStatCard label="Competidores" value={competidores.length} icon={Shield} variant="danger" size="sm" />
        </DSKPIBar>
      </div>
