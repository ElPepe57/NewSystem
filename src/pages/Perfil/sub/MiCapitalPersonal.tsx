...
export const MiCapitalPersonal: React.FC<{ embedded?: boolean }> = ({ embedded = false }) => {
    ...
    embedded ? (
      ...
      <div className="max-w-6xl mx-auto p-3 sm:p-4 md:p-6">
        <div className="bg-white rounded-2xl ring-1 ring-slate-200 overflow-hidden">
          <BackArrowHeader seccionLabel="Mi capital" icon={Coins} colorTone="violet" subtitulo={subtitulo} acciones={acciones} />
          {content}
        </div>
      </div>
    );
  ...
  return wrap(
    ...
    'Mi participación · aportes · ROI · distribuciones',
    accionesCapital,
  );
};
