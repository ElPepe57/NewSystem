...
export const CasillaFormModal: React.FC<Props> = ({ isOpen, onClose, onSaved, casilla, colaboradorId }) => {
  ...
  // S42k — La gestión de colaboradores secundarios se delegó al
  // AsociarColaboradorModal (accesible desde la casilla expandida en el listado).
  // Este form ahora solo gestiona los datos físicos de la casilla.
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // S42k — colaboradoresSecundariosIds se gestiona vía AsociarColaboradorModal.
      // No se toca aquí; el service preserva el campo si no viene en el payload.
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={casilla ? 'Editar Casilla' : 'Nueva Casilla'} size="lg">
      <div className="space-y-4">
        ...
        {/* S42k — Sección "Otros colaboradores..." removida del form.
             Se gestiona desde el listado (casilla expandida → "Asociar otro colaborador")
             vía el AsociarColaboradorModal dedicado. */}
