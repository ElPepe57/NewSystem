        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            {order.packId && (order.subOrderIds?.length || 0) > 1 && (
              <span className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded-full bg-teal-50 text-teal-600 font-medium">
...
export const OrderRow: React.FC<{ order: MLOrderSync; expanded?: boolean }> = ({ order, expanded }) => {
  ...
  const badges = (
    <>
      {isPack && (
        <span className="text-[10px] px-1.5 py-0.5 rounded bg-teal-50 text-teal-600 font-medium leading-none inline-flex items-center gap-0.5">
