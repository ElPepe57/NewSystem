...
const FILTROS_ESTADO: Array<{ id: 'todas' | EstadoBoleta; label: string; tinte: string }> = [
  { id: 'todas', label: 'Todas', tinte: 'bg-violet-100 text-violet-700' },
    ...
    <div className="p-4 sm:p-6 space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-violet-50 ring-1 ring-violet-200 rounded-xl p-3">
          <div className="text-[10px] uppercase font-bold text-violet-700">BOLETAS DEL MES</div>
          <div className="text-lg font-bold tabular-nums text-violet-900">{stats.total}</div>
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="bg-white border border-violet-300 text-violet-700 text-[11px] font-bold px-3 py-1.5 rounded-lg flex items-center gap-1.5 hover:bg-violet-50"
          >
          ...
          {boletas.length === 0 && (
            <button
              ...
              className="bg-violet-600 hover:bg-violet-700 text-white text-[11px] font-bold px-3 py-1.5 rounded-lg flex items-center gap-1.5"
            >
              <Plus className="w-3 h-3" />
              Generar del mes
            </button>
      ...
      {boletas.length === 0 && !loadingBoletas && (
        <div className="bg-gradient-to-br from-violet-50 to-cyan-50/40 ring-1 ring-violet-200 rounded-2xl p-8 text-center">
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap">
            <button
              type="button"
              onClick={() => setGenerarOpen(true)}
              className="bg-violet-600 hover:bg-violet-700 text-white text-[12px] font-bold px-4 py-2 rounded-lg inline-flex items-center gap-1.5"
            >
            ...
            <button
              type="button"
              onClick={() => setNuevaBoletaOpen(true)}
              className="bg-white border border-violet-300 text-violet-700 text-[12px] font-bold px-4 py-2 rounded-lg inline-flex items-center gap-1.5 hover:bg-violet-50"
            >
              <Plus className="w-3.5 h-3.5" />
              Nueva manual
            </button>
              ...
              >
                <div className="flex items-start gap-3 flex-wrap">
                  ...
                  <button
                    ...
                    className="w-11 h-11 rounded-full bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center text-white font-bold text-[13px] flex-shrink-0 hover:ring-2 hover:ring-violet-300 transition"
                  ...
                  <div className="flex-1 min-w-[200px]">
                    <div className="flex items-center gap-2 flex-wrap mb-0.5">
                      <button
                        ...
                        className="text-[13px] sm:text-[14px] font-bold text-slate-900 hover:text-violet-700 transition"
                        title="Ver perfil del empleado"
                      >
                        {b.empleadoNombre}
                      </button>
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0" onClick={(e) => e.stopPropagation()}>
                    <div className="text-right">
                      ...
                      <div className="text-[14px] sm:text-[15px] font-bold tabular-nums text-violet-900">
                    ...
                    {b.estado === 'aprobada' && (
                      <button
                        type="button"
                        onClick={() => setBoletaDetalle(b)}
                        className="p-1.5 hover:bg-violet-50 rounded text-violet-700"
                        title="Marcar pagada"
                      >
