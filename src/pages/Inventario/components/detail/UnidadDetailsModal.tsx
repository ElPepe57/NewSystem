      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-slate-900">{unidad.productoSKU}</div>
        ...
        <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 rounded-lg">
          <div>
            <div className="text-xs text-slate-500 uppercase mb-1">Lote</div>
            <div className="font-mono font-medium text-slate-900">{unidad.lote}</div>
          </div>
          <div>
            <div className="text-xs text-slate-500 uppercase mb-1">Orden de Compra</div>
            <div className="font-medium text-slate-900">{unidad.ordenCompraNumero}</div>
          </div>
        </div>
        ...
        <div className="bg-sky-50 p-4 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-medium text-slate-900">{unidad.almacenNombre}</span>
          </div>
        </div>
        ...
        <div className="bg-emerald-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <div className="text-xs text-slate-500">Costo USD</div>
            ...
            {unidad.costoFleteUSD !== undefined && unidad.costoFleteUSD > 0 && (
              <div>
                <div className="text-xs text-slate-500">Flete USD</div>
                <div className="text-lg font-bold text-slate-900">
            ...
            {unidad.tcPago !== undefined && (
              <div>
                <div className="text-xs text-slate-500">TC Pago</div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-semibold text-slate-900">Fechas Importantes</h4>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-slate-50 rounded-lg">
              <div className="text-xs text-slate-500">Recepción</div>
        ...
        {unidad.ventaId && (
          <div className="bg-purple-50 p-4 rounded-lg">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="font-semibold text-slate-900">Información de Venta</h4>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="text-xs text-slate-500">Número de Venta</div>
                <div className="font-medium text-slate-900">{unidad.ventaNumero}</div>
              </div>
              {unidad.precioVentaPEN !== undefined && (
                <div>
                  <div className="text-xs text-slate-500">Precio de Venta</div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h4 className="font-semibold text-slate-900">Unidad Reservada</h4>
                </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <span className="font-medium text-slate-900">{tipoInfo.label}</span>
