        ...
        <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
          <div className="flex items-start justify-between gap-3 sm:gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-1.5 flex-wrap justify-end">
              ...
              {/* Tier primary · Nuevo socio (CTA principal del módulo) */}
              <button
                type="button"
                onClick={() => setNuevoSocioOpen(true)}
                aria-label="Dar de alta a nuevo socio"
                title="Alta de socio al cap table · sin pasar por el wizard de usuarios"
