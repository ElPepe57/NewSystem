  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3">
      <div className="bg-white rounded-lg border border-slate-200 p-3">
        ...
        <p className="text-[10px] text-slate-400">distritos</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-3">
        ...
        <p className="text-[10px] text-slate-400">cobertura nacional</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-3">
        <div className="flex items-center gap-1.5 mb-1">
          ...
          <span className="text-[10px] sm:text-xs text-slate-500">Ticket Prom.</span>
        </div>
        <p className="text-lg sm:text-xl font-bold text-slate-900">
          S/ {kpis.ticketPromedio.toFixed(0)}
        </p>
        <p className="text-[10px] text-slate-400">por venta</p>
      </div>

      <div className="bg-white rounded-lg border border-slate-200 p-3">
        <div className="flex items-center gap-1.5 mb-1">
          <BarChart3 className="h-3.5 w-3.5 text-purple-500" />
          <span className="text-[10px] sm:text-xs text-slate-500">Zona Top</span>
        </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-3">
        <div className="flex items-center gap-1.5 mb-1">
          ...
          <span className="text-[10px] sm:text-xs text-slate-500">Cobertura</span>
        </div>
        <p className="text-lg sm:text-xl font-bold text-slate-900">{kpis.porcentajeCobertura}%</p>
        <p className="text-[10px] text-slate-400">{kpis.ventasGeolocalizadas}/{kpis.ventasTotales} ventas</p>
      </div>
    </div>
  );
}
