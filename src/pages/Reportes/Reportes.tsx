...
// S56 D-FIN-7-A: tabs CxC, CxP y CuentasCorrientes ELIMINADOS de Reportes.
// Toda la funcionalidad financiera relacional vive ahora en /finanzas (hub
// unificado). La vista por documento se accede desde el modal detalle de
// cada entidad en el hub.
    ...
    <PageShell>
        ...
        actions={activeTab === 'rentabilidad' ? (
          <>
            <button
              onClick={() => fetchAll()}
              disabled={loading}
              className="p-2 sm:px-3 sm:py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="p-2 sm:px-3 sm:py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50 disabled:opacity-50 flex items-center gap-1.5"
            >
      ...
      {activeTab !== 'rentabilidad' ? (
        <Suspense fallback={
          ...
          {/* S56 D-FIN-7-A: tabs CxC, CxP y CuentasCorrientes movidos a /finanzas */}
        </Suspense>
      ) : (
      <>
      ...
      {resumenEjecutivo && (
        <>
          ...
          <div>
            <h2 className="text-base sm:text-xl font-semibold text-slate-900 mb-3">Resumen Ejecutivo</h2>
            ...
            <div className={`grid gap-2.5 sm:gap-4 mt-2.5 sm:mt-4 ${resumenEjecutivo.costoEnvioAsumidoPEN > 0 ? 'grid-cols-2 sm:grid-cols-4' : 'grid-cols-3'}`}>
              {resumenEjecutivo.costoEnvioAsumidoPEN > 0 && (
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-2.5 sm:p-4">
                  <div className="flex items-center gap-1 mb-0.5">
                    ...
                    <span className="text-[10px] sm:text-xs text-slate-500">Envíos</span>
                  </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
                ...
                <div className="text-[10px] sm:text-xs text-slate-400">{invDisponibles} disp.</div>
              </div>

              <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
                <div className="flex items-center gap-1 mb-0.5">
                  <DollarSign className="h-3 w-3 sm:h-4 sm:w-4 text-slate-500" />
                  <span className="text-[10px] sm:text-xs text-slate-500">Inversión</span>
                </div>
                ...
                <div className="text-[10px] sm:text-xs text-slate-400">TC: {resumenEjecutivo.tcActual.toFixed(2)}</div>
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
                ...
                <div className="text-[10px] sm:text-xs text-slate-400">{resumenEjecutivo.ordenesActivas} OC activas</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-sm font-medium text-slate-500 mb-1.5 sm:mb-2">Ventas</div>
              <div className="space-y-1 sm:space-y-2">
                <div className="flex justify-between items-baseline gap-1">
                  <span className="text-[10px] sm:text-xs text-slate-400">Hoy</span>
                  <span className="text-[11px] sm:text-sm font-semibold text-slate-900 truncate">S/ {resumenEjecutivo.ventasHoy.toFixed(0)}</span>
                </div>
                <div className="flex justify-between items-baseline gap-1">
                  <span className="text-[10px] sm:text-xs text-slate-400">7d</span>
                  <span className="text-[11px] sm:text-sm font-semibold text-slate-900 truncate">S/ {resumenEjecutivo.ventasSemana.toFixed(0)}</span>
                </div>
                <div className="flex justify-between items-baseline gap-1">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-sm font-medium text-slate-500 mb-1.5 sm:mb-2">Inventario</div>
              <div className="space-y-1 sm:space-y-2">
                <div className="flex justify-between items-baseline gap-1">
                  <span className="text-[10px] sm:text-xs text-slate-400">Total</span>
                  <span className="text-[11px] sm:text-sm font-semibold text-slate-900">{resumenEjecutivo.unidadesTotales}</span>
                </div>
                <div className="flex justify-between items-baseline gap-1">
                ...
                <div className="flex justify-between items-baseline gap-1">
                  ...
                  <span className="text-[11px] sm:text-sm font-semibold text-slate-900">{resumenEjecutivo.productosActivos}</span>
                </div>
              </div>
            </div>

            <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-sm font-medium text-slate-500 mb-1.5 sm:mb-2">Compras</div>
              <div className="space-y-1 sm:space-y-2">
                <div className="flex justify-between items-baseline gap-1">
                ...
                <div className="flex justify-between items-baseline gap-1">
                  ...
                  <span className="text-[11px] sm:text-sm font-semibold text-slate-900">{resumenEjecutivo.tcPromedio.toFixed(3)}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {rentabilidadNeta && (
        <div className="bg-amber-50 border border-orange-200 rounded-xl p-3 sm:p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[10px] sm:text-xs text-slate-400 hidden sm:block">Modelo completo (7 capas)</span>
          </div>

          {/* 4 métricas compactas */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-3">
            <div className="bg-white rounded-lg p-2.5 sm:p-3 border border-slate-200">
              <div className="text-[10px] sm:text-xs text-slate-500 mb-0.5">Ventas Brutas</div>
              <div className="text-sm sm:text-xl font-bold text-slate-900 leading-tight">
                S/ {rentabilidadNeta.ventasBrutas.toLocaleString('es-PE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </div>
              <div className="text-[10px] text-slate-400">{rentabilidadNeta.unidadesVendidas} uds</div>
            </div>
          ...
          <div className="bg-white rounded-lg p-3 sm:p-4 border border-slate-200 text-xs sm:text-sm">
            <h4 className="text-xs font-medium text-slate-600 mb-2">Desglose (Modelo Completo)</h4>
      ...
      {ventasPorCanal && (
        <div className="grid grid-cols-3 gap-2 sm:gap-4">
          <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
            ...
            <div className="text-[11px] sm:text-sm text-slate-600 mt-0.5">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-2.5 sm:p-4">
            <div className="flex items-center justify-between mb-1 sm:mb-2">
              <div className="text-[10px] sm:text-sm text-slate-600">Otros</div>
      ...
      {productosRentabilidadCompleto.length > 0 && (
        <div className="bg-white border border-slate-200 rounded-xl p-3 sm:p-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3 sm:mb-4">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] sm:text-xs text-slate-400">Ver:</span>
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-3 sm:mb-4 text-[10px] sm:text-xs">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-slate-600">15-25%</span>
            </div>
            <div className="flex items-center gap-1">
