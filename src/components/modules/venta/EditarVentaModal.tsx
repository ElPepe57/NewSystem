      ...
      <div className="space-y-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200">
                  ...
                  <th className="text-center py-2 px-3 font-medium text-slate-600 w-32">Precio Unit.</th>
                  <th className="text-right py-2 pl-3 font-medium text-slate-600 w-28">Subtotal</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <tr key={prod.productoId} className="border-b border-slate-100">
                      <td className="py-2 pr-3">
                        <div className="font-medium text-slate-900 text-xs">{prod.marca}</div>
                        <div className="text-slate-500 text-xs">{prod.nombreComercial} - {prod.presentacion}</div>
                      </td>
                      <td className="py-2 px-3">
                        <input
                          ...
                          className={`w-full text-center text-sm border rounded-md px-2 py-1.5 ${
                            cantidadChanged ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                          } ${!esEstadoTemprano ? 'bg-slate-100 text-slate-500 cursor-not-allowed' : 'focus:ring-1 focus:ring-teal-500 focus:border-teal-500'}`}
                        />
                      </td>
                      <td className="py-2 px-3">
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full text-right text-sm border rounded-md pl-7 pr-2 py-1.5 ${
                              precioChanged ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">Costo de Envío (S/)</label>
              <input
                type="number"
                min="0"
                step="0.01"
                ...
                className={`w-full text-sm border rounded-md px-3 py-2 ${
                  costoEnvio !== (venta.costoEnvio || 0) ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">Descuento (S/)</label>
              <input
                type="number"
                min="0"
                step="0.01"
                ...
                className={`w-full text-sm border rounded-md px-3 py-2 ${
                  descuento !== (venta.descuento || 0) ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
              />
            </div>
          </div>
          {costoEnvio > 0 && (
            <div className="mt-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 bg-slate-50 p-3 rounded-lg">
              <span className="text-sm font-medium text-slate-700">Quién paga el envío:</span>
              <div className="flex gap-4">
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-slate-600">Nosotros (gratis para cliente)</span>
                </label>
                <label className="flex items-center cursor-pointer">
                  <input
                    type="radio"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    nombreCliente !== (venta.nombreCliente || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-slate-700 mb-1">DNI/RUC</label>
                <input
                  type="text"
                  value={dniRuc}
                  onChange={(e) => setDniRuc(e.target.value)}
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    dniRuc !== (venta.dniRuc || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    telefonoCliente !== (venta.telefonoCliente || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    emailCliente !== (venta.emailCliente || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    direccionEntrega !== (venta.direccionEntrega || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    distrito !== (venta.distrito || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className={`w-full text-sm border rounded-md px-3 py-2 ${
                    provincia !== (venta.provincia || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
                  } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
                />
              </div>
            </div>
        ...
        <div>
          ...
          <textarea
            ...
            className={`w-full text-sm border rounded-md px-3 py-2 resize-none ${
              observaciones !== (venta.observaciones || '') ? 'border-amber-400 bg-amber-50' : 'border-slate-300'
            } focus:ring-1 focus:ring-teal-500 focus:border-teal-500`}
        ...
        <div className="bg-slate-50 p-4 rounded-lg space-y-2">
          ...
          {costoEnvio > 0 && (
            <div className="flex justify-between text-sm">
              ...
              <span className={incluyeEnvio ? 'text-slate-400 line-through' : 'text-slate-900'}>
          ...
          <div className="flex justify-between text-base font-bold border-t border-slate-200 pt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={totalCambio ? 'text-amber-700' : 'text-slate-900'}>
