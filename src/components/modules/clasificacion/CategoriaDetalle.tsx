      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between border-b pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900">{categoria.nombre}</h2>
              {categoria.descripcion && (
                <p className="text-sm text-slate-500">{categoria.descripcion}</p>
              )}
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Tabla de productos */}
            {(() => {
              const columnasCat: DataTableColumn<ProductoEnClasificacion>[] = [
                {
                  key: 'producto',
                  header: 'Producto',
                  render: prod => (
                ...
                <div className="border border-slate-200 rounded-lg overflow-hidden">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    <DataTable
                      ...
                      compact
                      stickyHeader
                      emptyMessage="Sin productos en esta categoría"
                    />
                  </div>
                </div>
              );
