  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <label className="block text-sm font-medium text-slate-700 mb-1">
        <Tag className="inline-block w-4 h-4 mr-1 text-slate-400" />
        Etiquetas
      ...
      {!disabled && (
        <button
          ...
          className="w-full px-3 py-2 border border-slate-300 rounded-lg text-left flex items-center gap-2 hover:border-teal-400 transition-colors"
        >
          <Plus className="w-4 h-4 text-slate-400" />
          <span className="text-slate-500">Agregar etiqueta...</span>
        </button>
      )}
                ...
                {showCreateOption && (
                  <div className="border-b border-slate-100">
                    <div className="px-3 py-2 flex items-center gap-2">
                      <span className="text-sm text-slate-600">Crear como:</span>
                    ...
                    <button
                      ...
                      disabled={creating}
                      className="w-full px-4 py-3 flex items-center gap-2 text-left hover:bg-teal-50 text-teal-600"
                    >
