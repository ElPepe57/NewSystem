    ...
    <div className="space-y-5">
      ...
      <section className="border border-slate-200 rounded-lg overflow-hidden">
        <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 border-b border-slate-200">
          ...
          <span className="font-medium text-slate-900 text-sm">Costos Adicionales</span>
      ...
      <section className="border border-slate-200 rounded-lg overflow-hidden">
        <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 border-b border-slate-200">
          ...
          <span className="font-medium text-slate-900 text-sm">Desglose de Costos</span>
        </div>
        <div className="p-4">
          <div className="space-y-1.5 text-sm">
            ...
            <div className="flex justify-between font-semibold text-teal-700 pt-1">
              <span>TOTAL USD:</span>
