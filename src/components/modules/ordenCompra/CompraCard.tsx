/**
 * CompraCard — card de OC en el listado (simple + con sub-órdenes).
 *
 ...
 * El marcador "NO MODIFICAR" quedó DEROGADO. En rework hacia HubCard + EtiquetaProducto +
 * lucide (sin emojis) + color del grupo Comercial (blue). Validar contra mockup antes de tocar.
 */
