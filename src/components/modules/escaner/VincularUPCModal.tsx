        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-md focus:ring-teal-500 focus:border-teal-500"
              autoFocus
            />
          </div>
        </div>
          ...
          <div className="max-h-60 overflow-y-auto border border-slate-200 rounded-lg divide-y divide-slate-100">
            {filtered.map(p => (
              <button
                ...
                className="w-full px-3 py-2.5 flex items-center gap-3 hover:bg-slate-50 text-left transition-colors"
              >
