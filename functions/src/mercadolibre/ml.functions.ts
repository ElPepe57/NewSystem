/**
 * ml.functions.ts — Shim de compatibilidad
 *
 * Este archivo fue dividido en módulos más pequeños para reducir el cold start.
 * Re-exporta todo desde los módulos específicos para que cualquier import
 * directo a "./ml.functions" siga funcionando.
 *
 * Módulos resultantes:
